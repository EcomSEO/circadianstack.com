...
export default function AboutPage() {
  return (
    <TrustPageTemplate title="About CircadianStack">
      <p>CircadianStack exists because the information about non-toxic living is a mess.</p>
      <p>
      ...
      <p>
        We built CircadianStack to be the calm, cited, investigative resource
      ...
      <p>
        ...
        us. Write to us at{" "}
        <Link href="/contact">hello@circadianstack.com</Link>.
      </p>

      <p>The CircadianStack Team</p>
    </TrustPageTemplate>
  );
}
