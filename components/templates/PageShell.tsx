...
/**
 * Wide shell for money pages (pillar/comparison) that benefits from a
 * sticky TOC or lab-notebook aside on desktop. Narrower inner column
 * keeps reading width readable.
 */
